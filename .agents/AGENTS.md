...
| [`INSTALL.md`](file:///Users/kijjaz/Desktop/Antigravity/2026/20260801%20Time%20Dilation%20DAW/INSTALL.md) | **Compilation & Installation Manual**. Step-by-step instructions for compiling from source on macOS, Linux (Ubuntu/Debian, Fedora, Arch), and Windows (Visual Studio 2022 / MSVC / Ninja). |
...
| **TidalCycles Principles** | Open-Source BSD / GPL / Alex McLean ([tidalcycles.org](https://tidalcycles.org)) | Mini-notation pattern parsing concepts (`"scale 'minor' 0 [3 5] 7 10"`, `~` rests) adapted as inspiration into native C++ in [`RelativisticSequencers.cpp`](file:///Users/kijjaz/Desktop/Antigravity/2026/20260801%20Time%20Dilation%20DAW/Source/dsp/RelativisticSequencers.cpp). *Note: Native C++ implementation without external Haskell code dependencies.* |
